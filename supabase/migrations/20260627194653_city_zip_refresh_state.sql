...
-- Version: 20260627194653
-- Historical name: city_zip_refresh_state
-- Historical SQL is archived outside active migration discovery under supabase/migration-history/application/.
-- Canonical application state is supplied by numeric migration 021_city_zip_refresh_state.sql.

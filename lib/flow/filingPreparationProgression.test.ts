...
import { createFilingPreparationRecord, type FilingPreparationRecord } from './filingPreparationRecord';
...
requireBlocked(record, regenerated, current, 'CURRENT_GENERATED_DRAFT_MISMATCH', 'new generated bytes cannot inherit historical owner review');

...
- **Artifacts (with metadata):** 70 · **ADRs:** 15
- **By lifecycle:** Concept 18 · Implemented 3 · Operational 27 · Proposed 7 · Ratified 15
...
<!-- CBS-001 GENERATED STATS refreshed after BTRM-001/RP/RP-005/RP-006/RPT-014/RP-007/RPT-015 work — see the block above (~line 164) for the auto-generated count; this section is the hand-authored narrative for 2026-07-25. -->
## Next
BTRM-001 Stages 1 (ENR-001) and 2 (BAE-001) are shipped (dark). Next up is Stage 3 (TM-001/CM-001 real implementation, wiring the already-Proposed specs into BTRM-001 as the spec directs — reused, not redesigned), consuming BAE-001's BehavioralObservation output — same posture (flag-gated, dark, own PR). Independently, if the Founder wants to pursue RP-002, RP-005, RP-006, or RP-007 toward ratification, the next step for any of them is a reconciliation memo against the overlapping artifacts identified above — not a new CRID. RP-006 still needs the OPOS/OPIL-vs-EA-012 naming collision and EDIC's data-sourcing question resolved before any Architecture Draft (the RQS/OCM-001 conflict is now closed — see above). RP-007 (TBIE/CEE) is largely self-reconciled by its own text; its next real step, if the Founder prioritizes it ahead of BTRM-001 Stage 3-7, is an Architecture Draft scoping TBIE/CEE's data models as extensions of ENR-001/BAE-001 rather than a parallel schema.

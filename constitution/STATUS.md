...
<!-- CBS-001 GENERATED STATS refreshed after BTRM-001/RP/RP-005 work — see the block above (~line 164) for the auto-generated count; this section is the hand-authored narrative for 2026-07-25. -->
## Next
BTRM-001 Stage 1 (ENR-001) implementation. Independently, if the Founder wants to pursue RP-002 (Decision Calibration) or RP-005 (Adaptive Decision Intelligence), the next step for either is a reconciliation memo against the overlapping artifacts identified above — not a new CRID. RP-005 additionally needs its probability-vs-OCM-001 conflict (RPT-012 §2) resolved before any Architecture Draft.

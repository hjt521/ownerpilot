...
- **Build order:** Stage 0 ✅ → Stage 1 (ENR-001) ✅ → Stage 2 (BAE-001) ✅ → TM-001/CM-001 wiring → ICOA-001 → RIE-001 → OCM-001/CS-001 → POL-001, each its own reviewable PR. **No runtime path may reach an adverse action (eviction, denial, escalation, financial penalty) without `human_review_required`.**

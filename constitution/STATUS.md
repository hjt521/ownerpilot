...
- **ECAP-001 AI Assistant — DELIVERED through PROC-100 (RPT-007):** runtime monitoring shipped across all 5 chat error exits (PRs #265, #266); Stage-6 security review evidence-based against prod (`chat_sessions` RLS owner-scoped `auth.uid()=user_id`, anon denied, service-role writes — PASS; one deferred least-privilege grant observation); Stages 8/9/10 complete; `delivery_stage: released`. First Wave-1 stream complete. **Next:** ECAP-002 / ECAP-003 / ECAP-010.
...
- **Artifacts (with metadata):** 55 · **ADRs:** 12
- **By lifecycle:** Concept 12 · Implemented 3 · Operational 20 · Proposed 7 · Ratified 13

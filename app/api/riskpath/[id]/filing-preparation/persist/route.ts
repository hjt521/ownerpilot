...
function statusFor(result: FilingPreparationRuntimePersistenceResult): number {
  ...
  switch (result.blockReason) {
    ...
    case 'UNAUTHENTICATED':
      return 401;
    case 'CURRENT_STATE_UNAVAILABLE':
      return 404;
    ...
    case 'CURRENT_STATE_IDENTITY_MISMATCH':
    case 'CURRENT_STATE_MATERIAL_UNAVAILABLE':
    case 'CURRENT_EVIDENCE_BLOCKED':
      return 409;
    case 'AUTHENTICATION_FAILED':
    case 'CURRENT_STATE_LOOKUP_FAILED':
    case 'STORE_ERROR':
    default:
      return 503;
  }
